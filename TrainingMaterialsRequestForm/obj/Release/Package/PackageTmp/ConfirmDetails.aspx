<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmDetails.aspx.cs" Inherits="TrainingMaterialsRequestForm.ConfirmDetails" %>
            ...
            <h3>Participants</h3>
             ...
             <asp:FormView ID="FormView2" runat="server" DataKeyNames="participantID"  DataSourceID="SqlDataSource2" AllowPaging="True">
                 <EditItemTemplate>
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Name Required" ControlToValidate="participantNameTextBox" ForeColor="Red" Display="Dynamic" EnableClientScript="False"></asp:RequiredFieldValidator>
